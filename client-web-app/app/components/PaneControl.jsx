      ...
      <MuiThemeProvider>
        <div className={`main-wrapper nav-${navigatiorOpen ? 'visible' : 'hidden'}`}>
          <div className="control-tabs">
            <div onClick={() => this.switchTo('discover')} className="wrapper-control-button" >
            ...
            <div onClick={() => this.switchTo('messaging')} className="wrapper-control-button" >
            ...
            <div onClick={() => this.switchTo('profile')} className="wrapper-control-button">
